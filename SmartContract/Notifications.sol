...
contract Notifications {
    ...
    event ElectionVote(address indexed creator, string indexed voter, address indexed votedFor, uint256 electionId, uint256 timestamp);
    ...
    function notifyVoteCreator(address _creator, string memory _voter, address _votedFor, uint256 _electionId) external {
